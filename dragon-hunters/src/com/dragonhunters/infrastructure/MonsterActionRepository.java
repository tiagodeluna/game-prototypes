...
public class MonsterActionRepository implements Repository<MonsterActionCard, MonsterTypeEnum> {
	...
	public MonsterActionRepository() {
		...
		this.elements.add(new MonsterActionCard(2, "Block", MonsterTypeEnum.GENERAL, new ActionTypeEnum[]{ActionTypeEnum.DEFENSE}, 0));
		...
		this.elements.add(new MonsterActionCard(5, "Fierce Blow", MonsterTypeEnum.GENERAL, new ActionTypeEnum[]{ActionTypeEnum.GENERIC_ATK}, 1));
		
		this.elements.add(new MonsterActionCard(6, "Bite", MonsterTypeEnum.BEAST, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING}, 1));
		this.elements.add(new MonsterActionCard(7, "Claws", MonsterTypeEnum.BEAST, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING}, 1));
		this.elements.add(new MonsterActionCard(8, "Predator Rush", MonsterTypeEnum.BEAST, new ActionTypeEnum[]{ActionTypeEnum.MOVEMENT, ActionTypeEnum.CUTTING_PIERCING}, 2));
		this.elements.add(new MonsterActionCard(9, "Jump", MonsterTypeEnum.BEAST, new ActionTypeEnum[]{ActionTypeEnum.MOVEMENT, ActionTypeEnum.DEFENSE}, 1));

		this.elements.add(new MonsterActionCard(10, "Sting", MonsterTypeEnum.INSECT, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING}, 1));
		this.elements.add(new MonsterActionCard(11, "Defensive Shell", MonsterTypeEnum.INSECT, new ActionTypeEnum[]{ActionTypeEnum.DEFENSE}, 2));
		...
		this.elements.add(new MonsterActionCard(13, "Venomous Sting", MonsterTypeEnum.INSECT, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING, ActionTypeEnum.POISONOUS}, 1));
		...
		this.elements.add(new MonsterActionCard(15, "Thorns", MonsterTypeEnum.LIZARD, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING}, 1));
		...
		this.elements.add(new MonsterActionCard(18, "Take Flight", MonsterTypeEnum.FLYING, new ActionTypeEnum[]{ActionTypeEnum.MOVEMENT, ActionTypeEnum.DEFENSE}, 2));
		...
		this.elements.add(new MonsterActionCard(21, "Lacerating Attack", MonsterTypeEnum.FLYING, new ActionTypeEnum[]{ActionTypeEnum.MOVEMENT, ActionTypeEnum.CUTTING_PIERCING}, 2));
		...
		this.elements.add(new MonsterActionCard(23, "Poisonous Thorns", MonsterTypeEnum.PLANT, new ActionTypeEnum[]{ActionTypeEnum.CUTTING_PIERCING, ActionTypeEnum.POISONOUS}, 2));
